...
def register():
    ...
    Label(register_screen, text="Register your account for Eifanland", bg="yellow").pack()
...
def register_user():
    ...
    Label(register_screen, text="You have successfully registered for Einfland!", fg="green", font=("calibri", 11)).pack()
...
def login_sucess():
    ...
    Label(login_success_screen, text="Login Success", fg="green", font=("calibri", 11)).pack()
...
def main_account_screen():
    ...
    Label(text="Welcome to Einfland! Please select your choice", bg="yellow", width="300", height="2", font=("Calibri", 16)).pack()
    Label(text="").pack()
