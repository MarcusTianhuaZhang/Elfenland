...
def registerGame():
    ...
    body = """{
        "location": 'http://24.48.89.199:4243/Elfenland' ,
        "maxSessionPlayers": "6",
        "minSessionPlayers": "2",
        "name": "Elfenland",
    ...
    def display_host(self):
        ...
        while True:
            ...
            for event in pygame.event.get():
                ...
                if startButton and len(self.players) >=2: ##TO CHANGE
                    ...
                    if saveID == '':
                        ...
                        main(username_player, Variant.elfenland_org, len(self.players),owner,game_ID,saveID)
